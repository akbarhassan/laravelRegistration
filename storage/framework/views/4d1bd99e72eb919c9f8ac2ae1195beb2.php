    ...
    <div class="container">
        ...
        <div class="filter-container">
            <form method="GET" action="<?php echo e(route('admin.dashboard')); ?>">
                <input type="text" name="filter" placeholder="Search by name or email" value="<?php echo e($filter); ?>">
        ...
        <div class="table-container">
            <table>
                ...
                <tbody>
                    <?php $__currentLoopData = $learners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $learner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($learner->name); ?></td>
                            <td><?php echo e($learner->email); ?></td>
                            <td><?php echo e($learner->gender); ?></td>
                            <td><?php echo e($learner->phone_number); ?></td>
                            <td><?php echo e($learner->citizen ? 'Yes' : 'No'); ?></td>
                        </tr>
            ...
            <div class="pagination">
                <?php echo e($learners->appends(['filter' => $filter])->links('pagination::bootstrap-4')); ?>
...
<?php /**PATH C:\wamp64\www\learningPlatformNew\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>