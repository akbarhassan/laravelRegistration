...
<body>
    <div class="form-container">
        ...
        <form method="POST" action="<?php echo e(route('learner.register.submit')); ?>" id="registrationForm">
            <?php echo csrf_field(); ?>
                ...
                <div class="form-row">
                    <div class="form-col">
                        <div class="form-group">
                            ...
                            <?php $__errorArgs = ['is_representative'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <?php $__errorArgs = ['how_did_you_hear'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <form method="get" action="<?php echo e(route('learner.login')); ?>">
...
<?php /**PATH C:\wamp64\www\learningPlatformNew\resources\views/learner/register.blade.php ENDPATH**/ ?>