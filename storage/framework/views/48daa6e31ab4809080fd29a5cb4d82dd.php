...
<body>
    <div class="form-container">
        ...
        <form method="POST" action="<?php echo e(route('learner.login.submit')); ?>">
            <?php echo csrf_field(); ?>
        ...
        <form method="get" action="<?php echo e(route('learner.register')); ?>">
            <div class="form-group">
...
</html><?php /**PATH C:\wamp64\www\learningPlatformNew\resources\views/learner/login.blade.php ENDPATH**/ ?>